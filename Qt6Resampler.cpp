...
Qt6Resampler::Qt6Resampler(QObject *parent)
    :QObject(parent)
{

}

int  Qt6Resampler::init(AVCodecContext * dec_ctx,
...
QByteArray Qt6Resampler::convert(AVFrame* frame)
{
    QByteArray resByte;
